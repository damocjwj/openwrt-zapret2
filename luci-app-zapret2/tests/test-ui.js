...
assert(config.includes("class: 'td cbi-section-actions middle'"));
...
assert(profiles.includes("style: 'width:1%;min-width:max-content;text-align:center;white-space:nowrap'"));
assert(profiles.includes("cell.style.width = '1%'"));
assert(profiles.includes("cell.style.minWidth = 'max-content'"));
...
assert(profiles.includes("cell.style.whiteSpace = 'nowrap'"));
...
assert(stepTable.includes("cell.style.width = '1%'"));
assert(stepTable.includes("cell.style.minWidth = 'max-content'"));
...
assert(lists.includes("class: 'th cbi-section-actions top'"));
